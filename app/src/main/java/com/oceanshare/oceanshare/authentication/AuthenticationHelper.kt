...
class AuthenticationHelper {
    companion object {
        ...
        fun isPasswordConfirmationValid(context: Context?, passwordStr: String, passwordConfirmationStr: String): String? {
            ...
            if (TextUtils.isEmpty(passwordConfirmationStr)) {
                return context?.getString(R.string.error_field_required)
            }
            if (passwordConfirmationStr != passwordStr) {
                return context?.getString(R.string.error_password_confirmation_different)
            }
